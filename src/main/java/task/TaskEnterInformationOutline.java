...
public class TaskEnterInformationOutline implements Task {


    Data Data;

    public TaskEnterInformationOutline(model.Data data) {
        Data = data;
    }
    ...
    public static TaskEnterInformationOutline RegisterInformation(Data Data) {
        return Tasks.instrumented(TaskEnterInformationOutline.class, Data);
